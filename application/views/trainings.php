...
<!-- Mirrored from www.rollthemes.com/demo/html/brainstorm/trainings.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 22 Jul 2016 17:27:21 GMT -->
<head>
   <!-- Basic Page Needs -->
   <meta charset="utf-8">
...
<body>
        ...
        <div class="container page-title">
            <div class="page-title-wrapper">
                <div class="col-md-6 col-sm-6 breadcrumbs">
                    <ul>
                        <li><a href="#">Home</a></li>
                        <li class="last"><a href="#">Trainings</a></li>
                    </ul>
                </div><!-- /.col-md-6 -->
    ...
    <div class="head-trainings">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="roll-titlebox">
                        <h1 class="maintitle">Brainstorm trainings</h1>
                    </div><!-- /.roll-titlebox -->
    ...
    <!-- Find trainings -->
    <section class="find-training-single parallax">
    ...
    <!-- Popular post -->
    <section class="roll-row training-wrap">
        <div class="container">
            <div class="row">
                <div class="gallery-wrap" data-portfolio-effect="fadeInUp">
                    ...
                    <div class="col-md-4 col-sm-6 item gallery-item medicine it">
                        <div class="roll-popular-trainings">
                            <article class="post" data-animation="fadeInUp" data-animation-delay="0" data-animation-offset="75%">
                               <?php foreach ($fourth_trainings as $gallery_image) { ?>
                                <div class="feature-post">
                                    <img src="<?php echo $gallery_image->trainings_photo?>" alt="img">
                                    <div class="description">
                                        <div class="pattern-overlay-2"></div>
                    ...
                    <div class="col-md-4 col-sm-6 item gallery-item psychology business it">
                        <div class="roll-popular-trainings">
                            <article class="post" data-animation="fadeInUp" data-animation-delay="0" data-animation-offset="75%">
                                 <?php foreach ($fifth_trainings as $gallery_image) { ?>
                                <div class="feature-post">
                                    <img src="<?php echo $gallery_image->trainings_photo?>" alt="img">
                                    <div class="description">
                                        <div class="pattern-overlay-2"></div>
                    ...
                    <div class="col-md-4 col-sm-6 item gallery-item forwomen">
                        <div class="roll-popular-trainings">
                            <article class="post" data-animation="fadeInUp" data-animation-delay="0" data-animation-offset="75%">
                                 <?php foreach ($sixth_trainings as $gallery_image) { ?>
                                <div class="feature-post">
                                    <img src="<?php echo $gallery_image->trainings_photo?>" alt="img">
                                    <div class="description">
                                        <div class="pattern-overlay-2"></div>
                    ...
                    <div class="col-md-4 col-sm-6 item gallery-item medicine psychology">
                        <div class="roll-popular-trainings">
                            <article class="post" data-animation="fadeInUp" data-animation-delay="0" data-animation-offset="75%">
                                 <?php foreach ($seventh_trainings as $gallery_image) { ?>
                                <div class="feature-post">
                                    <img src="<?php echo $gallery_image->trainings_photo?>" alt="img">
                                    <div class="description">
                                        <div class="pattern-overlay-2"></div>
                    ...
                    <div class="col-md-4 col-sm-6 item gallery-item forwomen business it">
                        <div class="roll-popular-trainings">
                            <article class="post" data-animation="fadeInUp" data-animation-delay="0" data-animation-offset="75%">
                                <?php foreach ($eight_trainings as $gallery_image) { ?>
                                <div class="feature-post">
                                    <img src="<?php echo $gallery_image->trainings_photo?>" alt="img">
                                    <div class="description">
                                        <div class="pattern-overlay-2"></div>
                    ...
                    <div class="col-md-4 col-sm-6 item gallery-item finance forman">
                        <div class="roll-popular-trainings">
                            <article class="post" data-animation="fadeInUp" data-animation-delay="0" data-animation-offset="75%">
                                <?php foreach ($nine_trainings as $gallery_image) { ?>
                                <div class="feature-post">
                                    <img src="<?php echo $gallery_image->trainings_photo?>" alt="img">
                                    <div class="description">
                                        <div class="pattern-overlay-2"></div>
                    ...
                    <div class="col-md-4 col-sm-6 item gallery-item medicine it">
                        <div class="roll-popular-trainings">
                            <article class="post" data-animation="fadeInUp" data-animation-delay="0" data-animation-offset="75%">
                                <?php foreach ($ten_trainings as $gallery_image) { ?>
                                <div class="feature-post">
                                    <img src="<?php echo $gallery_image->trainings_photo?>" alt="img">
                                    <div class="description">
                                        <div class="pattern-overlay-2"></div>
                    ...
                    <div class="col-md-4 col-sm-6 item gallery-item psychology business it">
                        <div class="roll-popular-trainings">
                            <article class="post" data-animation="fadeInUp" data-animation-delay="0" data-animation-offset="75%">
                                <?php foreach ($eleven_trainings as $gallery_image) { ?>
                                <div class="feature-post">
                                    <img src="<?php echo $gallery_image->trainings_photo?>" alt="img">
                                    <div class="description">
                                        <div class="pattern-overlay-2"></div>
                    ...
                    <div class="col-md-4 col-sm-6 item gallery-item forwomen">
                        <div class="roll-popular-trainings">
                            <article class="post" data-animation="fadeInUp" data-animation-delay="0" data-animation-offset="75%">
                                 <?php foreach ($twelve_trainings as $gallery_image) { ?>
                                <div class="feature-post">
                                    <img src="<?php echo $gallery_image->trainings_photo?>" alt="img">
                                    <div class="description">
                                        <div class="pattern-overlay-2"></div>
                    ...
                    <div class="col-md-4 col-sm-6 item gallery-item forwomen">
                        <div class="roll-popular-trainings">
                            <article class="post" data-animation="fadeInUp" data-animation-delay="0" data-animation-offset="75%">
                                <?php foreach ($thirteen_trainings as $gallery_image) { ?>
                                <div class="feature-post">
                                    <img src="<?php echo $gallery_image->trainings_photo?>" alt="img">
                                    <div class="description">
                                        <div class="pattern-overlay-2"></div>
                    ...
                    <div class="col-md-4 col-sm-6 item gallery-item medicine psychology">
                        <div class="roll-popular-trainings">
                            <article class="post" data-animation="fadeInUp" data-animation-delay="0" data-animation-offset="75%">
                                 <?php foreach ($fourteen_trainings as $gallery_image) { ?>
                                <div class="feature-post">
                                    <img src="<?php echo $gallery_image->trainings_photo?>" alt="img">
                                    <div class="description">
                                        <div class="pattern-overlay-2"></div>
                    ...
                    <div class="col-md-4 col-sm-6 item gallery-item forwomen business it">
                        <div class="roll-popular-trainings">
                            <article class="post" data-animation="fadeInUp" data-animation-delay="0" data-animation-offset="75%">
                                <?php foreach ($fifteen_trainings as $gallery_image) { ?>
                                <div class="feature-post">
                                    <img src="<?php echo $gallery_image->trainings_photo?>" alt="img">
                                    <div class="description">
                                        <div class="pattern-overlay-2"></div>
                    ...
                    <div class="col-md-4 col-sm-6 item gallery-item forwomen business it">
                        <div class="roll-popular-trainings">
                            <article class="post" data-animation="fadeInUp" data-animation-delay="0" data-animation-offset="75%">
                                 <?php foreach ($sixteen_trainings as $gallery_image) { ?>
                                <div class="feature-post">
                                    <img src="<?php echo $gallery_image->trainings_photo?>" alt="img">
                                    <div class="description">
                                        <div class="pattern-overlay-2"></div>
                    ...
                    <div class="col-md-4 col-sm-6 item gallery-item finance forman">
                        <div class="roll-popular-trainings">
                            <article class="post" data-animation="fadeInUp" data-animation-delay="0" data-animation-offset="75%">
                                <?php foreach ($seventeen_trainings as $gallery_image) { ?>
                                <div class="feature-post">
                                    <img src="<?php echo $gallery_image->trainings_photo?>" alt="img">
                                    <div class="description">
                                        <div class="pattern-overlay-2"></div>
                    ...
                    <div class="col-md-4 col-sm-6 item gallery-item medicine it">
                        <div class="roll-popular-trainings">
                            <article class="post" data-animation="fadeInUp" data-animation-delay="0" data-animation-offset="75%">
                                 <?php foreach ($eighteen_trainings as $gallery_image) { ?>
                                <div class="feature-post">
                                    <img src="<?php echo $gallery_image->trainings_photo?>" alt="img">
                                    <div class="description">
                                        <div class="pattern-overlay-2"></div>
    ...
    <script type="text/javascript" src="<?php echo base_url();?>https://maps.googleapis.com/maps/api/js?sensor=false"></script>
...
<!-- Mirrored from www.rollthemes.com/demo/html/brainstorm/trainings.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 22 Jul 2016 17:27:55 GMT -->
</html>