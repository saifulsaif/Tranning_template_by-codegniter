...
<div id="main_container">
    ...
    <div class="left_content">
            ...
            <div class="sidebarmenu">
                ...
                <div class="submenu">
                    <ul>
                    <li><a href="header.php">Logo</a></li>
                    <li><a href="slider.php">Slider Photo</a></li>
                    <li><a href="">Team Member Photo</a></li>
                    <li><a href="">Protfolio</a></li>
                    <li><a href="">Sidebar submenu</a></li>
                    </ul>
                </div>
                <a class="menuitem" href="<?php echo base_url();?>super_admin/header.php">logo</a>
              <a class="menuitem" href="slider.php">Slider</a>

                <a class="menuitem submenuheader" href="<?php echo base_url();?>super_admin/header_info">header</a>
                <div class="submenu">
                    <ul>
                    <li><a href="<?php echo base_url();?>super_admin/header_info">header_info</a></li>
                    <li><a href="<?php echo base_url();?>super_admin/header_info">Sidebar submenu</a></li>
                    <li><a href="">Sidebar submenu</a></li>
                    <li><a href="">Sidebar submenu</a></li>
                    <li><a href="">Sidebar submenu</a></li>
                    </ul>
